...
typedef enum
{
  ...
  AFF_HAWK_SPIRIT, AFF_WOLF_SPIRIT, AFF_ENLARGE, AFF_INSANE, AFF_BEASTMELD, AFF_SEARING_HAZE, AFF_147, AFF_148, AFF_149, AFF_150,
...
#define mudstrlcpy(d, s, z) newmudstrlcpy((d), (s), (z), NULL, 0)
