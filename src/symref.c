...
DO_FUN                 *skill_function args( ( char *name ) )
{
    ...
    case 'r':
        ...
        if(!str_cmp(name, "do_rpmote")) return do_rpmote;
    ...
    case 's':
        ...
        if(!str_cmp(name, "do_smote")) return do_smote;
...
const char             *skill_name( DO_FUN *skill )
{
    ...
    if(skill == do_rpmote) return "do_rpmote";
    if(skill == do_smote) return "do_smote";
